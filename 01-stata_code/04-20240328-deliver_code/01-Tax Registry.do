	...
	*/
		...
		**
		*------------------------------------------------------------------------------------------------------------------------------------->>
		import 	delimited using "${path_project}/data/raw\Tax Registry-2010-2018.csv", clear 
	 ...
	 *	br cd_10	cd_17	cd_28	cd_66	cd_74	cd_77	cd_78
			...
			* Da para fazer. mas é arriscado
			* replace employees=1 if legalformid==1
			
			*---------------------------------------------------------------------------------------------------------------------------------->>
			compress
			sort fuid period
			save "${path_project}/data/02-inter\Tax Registry.dta", replace
